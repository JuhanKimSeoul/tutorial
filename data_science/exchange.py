...
async def test(exchanges):
    ...
    while True:
        ...
        tasks = [find_real_kimp(i.exchange_x, i.exchange_y, i.symbol, 1_000_000) for _, i in batch]
        results = await asyncio.gather(*tasks)
        
        ret.append(r.get('real_kimp'))
