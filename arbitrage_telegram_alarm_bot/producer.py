...
def schedule_tasks():
    ...
    test_data = [
        ...
        [{'exchange': 'upbit', 'ticker': 'UNI'}],
        [{'exchange': 'upbit', 'ticker': 'LTC'}],
        [{'exchange': 'upbit', 'ticker': 'LINK'}],
        [{'exchange': 'upbit', 'ticker': 'VET'}],
        [{'exchange': 'upbit', 'ticker': 'TRX'}],
        [{'exchange': 'upbit', 'ticker': 'EOS'}],
        [{'exchange': 'upbit', 'ticker': 'XLM'}],
        [{'exchange': 'upbit', 'ticker': 'ATOM'}],
        [{'exchange': 'upbit', 'ticker': 'THETA'}],
        [{'exchange': 'upbit', 'ticker': 'XEM'}],
        [{'exchange': 'upbit', 'ticker': 'MATIC'}],
        [{'exchange': 'upbit', 'ticker': 'ICX'}],
        [{'exchange': 'upbit', 'ticker': 'ETC'}],
        [{'exchange': 'upbit', 'ticker': 'QTUM'}],
        [{'exchange': 'upbit', 'ticker': 'ENJ'}],
        [{'exchange': 'upbit', 'ticker': 'HBAR'}],
        [{'exchange': 'upbit', 'ticker': 'ZIL'}],
        [{'exchange': 'upbit', 'ticker': 'WAVES'}],
        [{'exchange': 'upbit', 'ticker': 'OMG'}],
        [{'exchange': 'upbit', 'ticker': 'SAND'}],
        [{'exchange': 'upbit', 'ticker': 'ANKR'}],
        [{'exchange': 'upbit', 'ticker': 'STMX'}],
        [{'exchange': 'upbit', 'ticker': 'MANA'}],
        [{'exchange': 'upbit', 'ticker': 'ONG'}],
        [{'exchange': 'upbit', 'ticker': 'GAS'}],
        [{'exchange': 'upbit', 'ticker': 'AERGO'}],
        [{'exchange': 'upbit', 'ticker': 'BTT'}],
    ]
